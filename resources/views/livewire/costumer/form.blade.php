...
@section('content')
    <form class="flex flex-wrap w-full md:w-1/2 p-2 justify-evenly" method="POST" action="{{ route('root.register.costumer') }}">
        ...
        <div class="flex flex-col sm:flex-row flex-wrap justify-center w-full">
            <div class="w-full sm:w-1/2 p-2">
                ...
                <div class="relative">
                    ...
                    <input type="tel" id="phone-input" name="phone" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="99 9999-9999">
                </div>
            </div>
            ...
            <div class="w-full sm:w-1/2 p-2">
                ...
                <div class="relative mb-6">
                    ...
                    <input type="text" id="input-group-1" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="exemplo@email.com">
                </div>
            </div>
        </div>
        {{--        FOTO--}}
        <div class="w-full p-2">
            ...
            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 light:text-gray-400 focus:outline-none light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" name="costumer_photo">
